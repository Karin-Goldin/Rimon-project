  ...
  return (
    <section id="hetmed" className="mx-auto min-h-full w-5/6 py-20">
        ...
        <div className="md:flex md:items-start md:justify-between gap-10">
          ...
          <div className="md:basis-3/5">
            ...
            <p className="my-5 text-xl">
              ...
              while putting an emphasis on trade in full hedge (long short) and
              in any market situation. The trade strategy of the fund allows it
              to maintain low, guaranteed and predefined risk level.
            </p>
            <p className="my-5 text-xl font-extrabold">
              “Based on its unique strategy, HETMED Fund is able to commit to a
              maximum and predefined risk level!”
            </p>
            <p className="my-5 text-xl">
      ...
      <p className="my-5 text-xl">
        ...
        while protecting investors' funds and in a variety of market conditions,
        by identifying short-term trends stemming from momentum in the prices of
        traded assets.
      </p>{" "}
      ...
      <p className="my-5 text-lg">
        ...
        the impressive returns. The fund’s profits are only based on success and
        we do not charge management fees. Therefore it ensures a common interest
        for the fund manager and it’s investors.
      </p>
