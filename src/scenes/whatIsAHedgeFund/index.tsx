          ...
          <div className="md:items-start md:justify-between gap-10">
            ...
            <Htext3>In order to protect all partners, the Fund employs two important gatekeepers:</Htext3>
                ...
                <div className="mt-3 py-3 rounded-md border-2 border-gray-100 px-5 py-16">
                    ...
                    <Htext3Pink>Trustee attorney. <span className="text-gray-500 text-xl">Attorney is the only authorized signatory in the fund's investors account. The task of the trustee is to ensure that investors' funds are directed solely for investment purposes, without the ability to use or transfer the funds for other purposes.</span></Htext3Pink>
                </div>
                <div className="mt-3 py-3 rounded-md border-2 border-gray-100 px-5 py-16 ">
                    <img src={Personal} alt="Personal" className="w-24 my-5"/>
                    <Htext3Pink>CPA. <span className="text-gray-500 text-xl">Responsible for profit and loss calculations, reports to investors, and distribution of profits to partners. The CPA is certified by the tax authorities as a tax trustee and is able to perform tax calculations for the fund's partners in order to prevent overpayment.</span></Htext3Pink>
                </div>   
                </div>

                <HText2>The Bottom Line</HText2> 
                <p className="text-xl py-5 py-8">"Since the commencement of its operations, HETMED Hedge Fund has achieved double-digit annual returns that have beaten the market, all the while maintaining low volatility, a defined and guaranteed risk level, and liquidity. "</p>
                <p className="text-xl py-5 py-8 font-bold border-t border-gray-300">We invite you to join our family of investors here in HETMED Hedge from Rimon Hedge Funds Ltd. and enjoy surprising returns and with zero management fees.</p>
                <br/> 
